...
| 페이지 | 내용 |
| --- | --- |
| [프로젝트 아키텍처](01-Architecture) | Monitoring VM, App VM 구성과 telemetry/request 흐름 |
| [사전 요구사항](02-Prerequisites) | VM 사양, 필수 소프트웨어, 버전 기준 |
| [네트워크 및 포트 정책](03-Network-and-Ports) | Security Group inbound 정책과 서비스 포트 |
| [설치 및 기동 방법](04-Installation-and-Runbook) | Monitoring VM, App VM 설치 및 실행 절차 |
| [서비스 접속 정보](05-Service-Access) | Grafana 접속 정보와 주요 내부 endpoint |
| [주요 설정](06-Configuration) | 핵심 설정 파일, 환경 변수, App VM ConfigMap |
| [Grafana](07-Grafana) | Dashboard, alert rule, Explore 쿼리 |
| [애플리케이션 시범 운영](08-Demo-Operations) | 랜덤 트래픽 생성과 장기 관찰 |
| [장애 테스트](09-Fault-Tests) | App/MSA 및 Monitoring backend 장애 테스트 |
| [트러블슈팅](10-Troubleshooting) | No data, metric missing, alert count 이슈 대응 |
